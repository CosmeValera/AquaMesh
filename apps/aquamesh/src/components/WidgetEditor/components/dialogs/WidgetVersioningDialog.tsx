          ...
          {!widget ? (
            ...
            <Box sx={{ display: 'flex', height: '500px' }}>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ flexGrow: 1, overflow: 'auto', pl: 2 }}>
                  {versions.length === 0 ? (
              ...
              <Box sx={{ 
                ...
                {selectedVersion ? (
                  <>
                    ...
                    {/* Component count comparison with improved clarity */}
      ...
      >
        ...
        <DialogContent sx={{ mt: 2 }}>
          <Alert severity="warning" variant="outlined" sx={{ mb: 2 }}>
            This action will create a new branch from this version and discard all later versions.
          </Alert>
          <DialogContentText>
            You are about to restore an older version of this widget. All versions created after this one will be discarded permanently.
          </DialogContentText>
          <Typography variant="body2" sx={{ mt: 2, color: 'text.secondary' }}>
            If you want to keep these future versions, you should export them before proceeding with the restoration.
          </Typography>
        </DialogContent>
        <DialogActions sx={{ px: 3, pb: 3 }}>
          ...
          >
            Restore and Discard Future Versions
          </Button>
        </DialogActions>
      </Dialog>
    </>
