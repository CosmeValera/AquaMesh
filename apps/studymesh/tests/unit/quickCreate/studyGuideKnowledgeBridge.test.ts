        ...
        geminiResponse(
          JSON.stringify({
            ...
            correspondences: [
              ...
              {
                knownSide: 'appending an entry',
                targetSide: 'producer',
                carries: 'how new units arrive over time',
                kind: 'process',
              },
              {
              ...
              {
                knownSide: 'ledger position',
                targetSide: 'offset',
                carries: 'where a reader has got to',
                kind: 'part',
              },
              {
                knownSide: 'reading an entry again',
                targetSide: 'replay',
                carries: 'how a past unit is consumed a second time',
                kind: 'process',
              },
            ],
