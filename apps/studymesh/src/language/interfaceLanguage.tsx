...
const translations = {
  en: {
    ...
    'demo.bannerBody':
      'This is a prepared sample. Everything on the page was generated by RabbitHole.',
  ...
  es: {
    ...
    'demo.bannerBody':
      'Esto es una muestra preparada. Todo lo que ves en la página lo generó RabbitHole.',
...
> = {
  fr: {
    ...
    'demo.bannerBody':
      'Ceci est un exemple préparé. Tout ce qui est sur la page a été généré par RabbitHole.',
  ...
  de: {
    ...
    'demo.bannerBody':
      'Das ist ein vorbereitetes Beispiel. Alles auf dieser Seite wurde von RabbitHole erzeugt.',
