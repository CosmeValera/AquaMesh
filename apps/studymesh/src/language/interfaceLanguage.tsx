...
const translations = {
  en: {
    ...
    'guest.of': 'of',
    'guest.freeQuickGuidesLeft': 'free Quick Guides left',
    'guest.title': 'Try it without an account',
    'guest.subtitle':
      'Tell RabbitHole what you want to learn. You get a guide with pages, quizzes and exercises you can practice on.',
    'guest.promptLabel': 'What do you want to learn?',
    'guest.promptPlaceholder':
      'Explain database indexes to me. I already know how the index at the back of a book works.',
    'guest.generate': 'Build my Quick Guide',
    'guest.generating': 'Building your Quick Guide...',
    'guest.generateFailed': 'Could not build the Quick Guide.',
    'guest.yourGuides': 'Your Quick Guides',
    'guest.yourGuidesHelp':
      'Saved to this browser and to your guest session. Create a free account to keep them.',
    'guest.open': 'Open',
    'guest.upgradeTitle': "You've used your 3 free Quick Guides",
    'guest.upgradeBody':
      'Your guides are already saved. Create a free account to keep them and get 30 Carrots for more.',
    'guest.name': 'Name (optional)',
    'guest.email': 'Email',
    'guest.password': 'Password',
    'guest.passwordHelpPrefix': 'Use at least',
    'guest.passwordHelpSuffix': 'characters.',
    'guest.passwordTooShort': 'That password is too short.',
    'guest.createAccount': 'Create free account',
    'guest.creatingAccount': 'Creating your account...',
    'guest.upgradeFailed': 'Could not create the account.',
  },
  es: {
    'topnav.user': 'Usuario',
    ...
    'guest.of': 'de',
    'guest.freeQuickGuidesLeft': 'guías rápidas gratis restantes',
    'guest.title': 'Pruébalo sin crear cuenta',
    'guest.subtitle':
      'Dile a RabbitHole qué quieres aprender. Recibes una guía con páginas, quizzes y ejercicios para practicar.',
    'guest.promptLabel': '¿Qué quieres aprender?',
    'guest.promptPlaceholder':
      'Explícame los índices de base de datos. Ya sé cómo funciona el índice de un libro.',
    'guest.generate': 'Crear mi guía rápida',
    'guest.generating': 'Creando tu guía rápida...',
    'guest.generateFailed': 'No se pudo crear la guía rápida.',
    'guest.yourGuides': 'Tus guías rápidas',
    'guest.yourGuidesHelp':
      'Guardadas en este navegador y en tu sesión de invitado. Crea una cuenta gratis para conservarlas.',
    'guest.open': 'Abrir',
    'guest.upgradeTitle': 'Has usado tus 3 guías rápidas gratis',
    'guest.upgradeBody':
      'Tus guías ya están guardadas. Crea una cuenta gratis para conservarlas y recibir 30 zanahorias para crear más.',
    'guest.name': 'Nombre (opcional)',
    'guest.email': 'Email',
    'guest.password': 'Contraseña',
    'guest.passwordHelpPrefix': 'Usa al menos',
    'guest.passwordHelpSuffix': 'caracteres.',
    'guest.passwordTooShort': 'Esa contraseña es demasiado corta.',
    'guest.createAccount': 'Crear cuenta gratis',
    'guest.creatingAccount': 'Creando tu cuenta...',
    'guest.upgradeFailed': 'No se pudo crear la cuenta.',
  },
} as const
...
> = {
  fr: {
    ...
    'guest.of': 'sur',
    'guest.freeQuickGuidesLeft': 'guides rapides gratuits restants',
    'guest.title': 'Essayez sans créer de compte',
    'guest.subtitle':
      'Dites à RabbitHole ce que vous voulez apprendre. Vous recevez un guide avec des pages, des quiz et des exercices pour vous entraîner.',
    'guest.promptLabel': 'Que voulez-vous apprendre ?',
    'guest.promptPlaceholder':
      "Explique-moi les index de base de données. Je sais déjà comment fonctionne l'index à la fin d'un livre.",
    'guest.generate': 'Créer mon guide rapide',
    'guest.generating': 'Création de votre guide rapide...',
    'guest.generateFailed': 'Impossible de créer le guide rapide.',
    'guest.yourGuides': 'Vos guides rapides',
    'guest.yourGuidesHelp':
      'Enregistrés dans ce navigateur et dans votre session invité. Créez un compte gratuit pour les conserver.',
    'guest.open': 'Ouvrir',
    'guest.upgradeTitle': 'Vous avez utilisé vos 3 guides rapides gratuits',
    'guest.upgradeBody':
      'Vos guides sont déjà enregistrés. Créez un compte gratuit pour les conserver et recevoir 30 carottes pour en créer d’autres.',
    'guest.name': 'Nom (facultatif)',
    'guest.email': 'E-mail',
    'guest.password': 'Mot de passe',
    'guest.passwordHelpPrefix': 'Utilisez au moins',
    'guest.passwordHelpSuffix': 'caractères.',
    'guest.passwordTooShort': 'Ce mot de passe est trop court.',
    'guest.createAccount': 'Créer un compte gratuit',
    'guest.creatingAccount': 'Création de votre compte...',
    'guest.upgradeFailed': 'Impossible de créer le compte.',
  },
  de: {
    ...
    'guest.of': 'von',
    'guest.freeQuickGuidesLeft': 'kostenlose Quick Guides übrig',
    'guest.title': 'Ohne Konto ausprobieren',
    'guest.subtitle':
      'Sag RabbitHole, was du lernen willst. Du bekommst einen Guide mit Seiten, Quizfragen und Übungen zum Trainieren.',
    'guest.promptLabel': 'Was willst du lernen?',
    'guest.promptPlaceholder':
      'Erklär mir Datenbank-Indizes. Ich weiß schon, wie das Stichwortverzeichnis in einem Buch funktioniert.',
    'guest.generate': 'Meinen Quick Guide erstellen',
    'guest.generating': 'Dein Quick Guide wird erstellt...',
    'guest.generateFailed': 'Der Quick Guide konnte nicht erstellt werden.',
    'guest.yourGuides': 'Deine Quick Guides',
    'guest.yourGuidesHelp':
      'In diesem Browser und in deiner Gastsitzung gespeichert. Erstelle ein kostenloses Konto, um sie zu behalten.',
    'guest.open': 'Öffnen',
    'guest.upgradeTitle': 'Du hast deine 3 kostenlosen Quick Guides genutzt',
    'guest.upgradeBody':
      'Deine Guides sind bereits gespeichert. Erstelle ein kostenloses Konto, um sie zu behalten und 30 Karotten für weitere zu bekommen.',
    'guest.name': 'Name (optional)',
    'guest.email': 'E-Mail',
    'guest.password': 'Passwort',
    'guest.passwordHelpPrefix': 'Verwende mindestens',
    'guest.passwordHelpSuffix': 'Zeichen.',
    'guest.passwordTooShort': 'Dieses Passwort ist zu kurz.',
    'guest.createAccount': 'Kostenloses Konto erstellen',
    'guest.creatingAccount': 'Dein Konto wird erstellt...',
    'guest.upgradeFailed': 'Das Konto konnte nicht erstellt werden.',
  },
}
