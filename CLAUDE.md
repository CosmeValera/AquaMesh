...
- `apps/studymesh/tests/live/` holds live-network harnesses for this flow (`bridgeLive.ts`, `bridgeAb.ts`). They cost real credits, are excluded from `test:unit`, and are run by hand with `npx tsx`.
