...
I want to understand burnout properly rather than just telling everyone to take a day off. What is actually happening to people, what are the early signals, and what can a manager realistically change versus what is outside their control?`,
  ...
  // Held-out probe sets, 2026-08. Every expectation was written down before the
  // call was made. Measured 7 false strongs out of 13 weak-expected cases on the
  // pre-2026-08-23 prompt, which is what the bar-led rewrite targets.
  {
    name: 'vaccine x fire drills',
    group: 'probe',
    topic: 'How does a vaccine train the immune system?',
    knownTopics: ['fire drills'],
    expect: 'strong',
  },
  {
    name: 'photosynthesis x riding a bike',
    group: 'probe',
    topic: 'How does photosynthesis work?',
    knownTopics: ['learning to ride a bike'],
    expect: 'weak',
  },
  {
    name: 'blockchain consensus x jury verdict',
    group: 'probe',
    topic: 'How does a blockchain reach consensus on which transactions are valid?',
    knownTopics: ['a jury reaching a verdict'],
    expect: 'strong',
  },
  {
    name: 'sky blue x tying shoelaces',
    group: 'probe',
    topic: 'Why is the sky blue?',
    knownTopics: ['tying shoelaces'],
    expect: 'weak',
  },
  {
    name: 'cleopatra x changing a lightbulb',
    group: 'probe',
    topic: 'Who was Cleopatra and why does she matter?',
    knownTopics: ['changing a lightbulb'],
    expect: 'weak',
  },
  {
    name: 'black holes x bathtub drain',
    group: 'probe',
    topic: 'How do black holes form?',
    knownTopics: ['a bathtub draining'],
    expect: 'weak',
  },
  {
    name: 'natural selection x training a dog',
    group: 'probe',
    topic: 'How does natural selection work?',
    knownTopics: ['training a dog'],
    expect: 'weak',
  },
  // Structural/taxonomic skills: few or no moving parts on the known side.
  {
    name: 'S1 periodic table x wedding seating plan',
    group: 'static',
    topic: 'How does the periodic table organise the elements?',
    knownTopics: ['a wedding seating plan'],
    expect: 'strong',
  },
  {
    name: 'S2 lat/long x spreadsheet grid',
    group: 'static',
    topic: 'How do latitude and longitude locate a place on Earth?',
    knownTopics: ['a spreadsheet grid'],
    expect: 'strong',
  },
  {
    name: 'S3 EM spectrum x piano keyboard',
    group: 'static',
    topic: 'What is the electromagnetic spectrum?',
    knownTopics: ['a piano keyboard'],
    expect: 'strong',
  },
  {
    name: 'S4 food web x org chart',
    group: 'static',
    topic: 'How does a food web organise an ecosystem?',
    knownTopics: ['an organisation chart'],
    expect: 'strong',
  },
  {
    name: 'S5 DNA storage x library card catalogue',
    group: 'static',
    topic: 'How does DNA store genetic information?',
    knownTopics: ['a library card catalogue'],
    expect: 'strong',
  },
  {
    name: 'S6 inflation x thermometer',
    group: 'static',
    topic: 'How does inflation erode savings?',
    knownTopics: ['a thermometer'],
    expect: 'weak',
  },
  {
    name: 'S7 doppler x colour wheel',
    group: 'static',
    topic: 'What is the Doppler effect?',
    knownTopics: ['a colour wheel'],
    expect: 'weak',
  },
  {
    name: 'S8 rainbow x stained glass window',
    group: 'static',
    topic: 'How does a rainbow form?',
    knownTopics: ['a stained glass window'],
    expect: 'weak',
  },
  {
    name: 'S9 berlin wall x paperclip',
    group: 'static',
    topic: 'Why did the Berlin Wall fall?',
    knownTopics: ['a paperclip'],
    expect: 'weak',
  },
  {
    name: 'S10 antibiotics x doormat',
    group: 'static',
    topic: 'How do antibiotics kill bacteria?',
    knownTopics: ['a doormat'],
    expect: 'weak',
  },
  // Process-rich skills: these supply enough nameable stages to reach any pair
  // count, so the weak-expected half is where false strongs concentrate.
  {
    name: 'D1 kidney x water treatment plant',
    group: 'dynamic',
    topic: 'How does the kidney filter blood?',
    knownTopics: ['running a water treatment plant'],
    expect: 'strong',
  },
  {
    name: 'D2 CPU scheduling x ER triage',
    group: 'dynamic',
    topic: 'How does a CPU decide which task to run next?',
    knownTopics: ['emergency room triage'],
    expect: 'strong',
  },
  {
    name: 'D3 nitrogen cycle x composting',
    group: 'dynamic',
    topic: 'How does the nitrogen cycle work?',
    knownTopics: ['composting'],
    expect: 'strong',
  },
  {
    name: 'D4 nerve signal x relay race',
    group: 'dynamic',
    topic: 'How does a nerve signal travel along a neuron?',
    knownTopics: ['running a relay race'],
    expect: 'strong',
  },
  {
    name: 'D5 heart circulation x central heating',
    group: 'dynamic',
    topic: 'How does the heart circulate blood around the body?',
    knownTopics: ['a central heating system'],
    expect: 'strong',
  },
  {
    name: 'D6 2008 crisis x sourdough starter',
    group: 'dynamic',
    topic: 'What caused the 2008 financial crisis?',
    knownTopics: ['making a sourdough starter'],
    expect: 'weak',
  },
  {
    name: 'D7 entanglement x restaurant kitchen',
    group: 'dynamic',
    topic: 'How does quantum entanglement work?',
    knownTopics: ['running a restaurant kitchen'],
    expect: 'weak',
  },
  {
    name: 'D8 language change x air traffic control',
    group: 'dynamic',
    topic: 'Why do languages change over time?',
    knownTopics: ['air traffic control'],
    expect: 'weak',
  },
  {
    name: 'D9 earthquake x conducting an orchestra',
    group: 'dynamic',
    topic: 'How does an earthquake happen?',
    knownTopics: ['conducting an orchestra'],
    expect: 'weak',
  },
  {
    name: 'D10 supernova x marathon training plan',
    group: 'dynamic',
    topic: 'Why do stars explode as supernovae?',
    knownTopics: ['following a marathon training plan'],
    expect: 'weak',
  },
  // Ask-3 held-out set, 2026-08-23. Expectations written before any call.
  {
    name: 'A insulin x thermostat',
    group: 'ask3',
    topic: 'How does insulin regulate blood sugar?',
    knownTopics: ['a thermostat in a house'],
    expect: 'strong',
  },
  {
    name: 'B gothic architecture x sourdough',
    group: 'ask3',
    topic: 'What are the main features of Gothic architecture?',
    knownTopics: ['making sourdough bread'],
    expect: 'weak',
  },
  {
    name: 'C roman republic x group chat',
    group: 'ask3',
    topic: 'Why did the Roman Republic fall?',
    knownTopics: ['a group chat falling apart'],
    expect: 'weak',
  },
]
