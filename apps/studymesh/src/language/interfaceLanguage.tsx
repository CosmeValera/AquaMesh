...
const translations = {
  en: {
    ...
    'workspace.pageBeingWritten': 'Writing this page...',
    'workspace.pagesReadySoon': 'Ready in about 20 seconds',
    'studyGuides.reconnecting': 'Reconnecting to check on this guide...',
    ...
    'workspace.pageToGuideTitle': 'Want to go all the way in?',
    'workspace.pageToGuideBody':
      'This page only scratches the subject. Turn it into a guide of its own.',
    'workspace.pageToGuideAction': 'Create a guide on this',
    ...
    'practice.addTopicToKnown': 'Add to what I know',
    'practice.addTopicRevisePages':
  ...
  es: {
    ...
    'workspace.pageBeingWritten': 'Escribiendo esta página...',
    'workspace.pagesReadySoon': 'Listas en unos 20 segundos',
    'studyGuides.reconnecting': 'Reconectando para comprobar esta guía...',
    ...
    'workspace.pageToGuideTitle': '¿Quieres entrar del todo?',
    'workspace.pageToGuideBody':
      'Esta página solo roza el tema. Conviértelo en una guía propia.',
    'workspace.pageToGuideAction': 'Crear una guía sobre esto',
    ...
    'practice.addTopicToKnown': 'Añadir a lo que sé',
    'practice.addTopicRevisePages':
...
> = {
  fr: {
    ...
    'workspace.pageBeingWritten': 'Rédaction de cette page...',
    'workspace.pagesReadySoon': 'Prêtes dans environ 20 secondes',
    'studyGuides.reconnecting': 'Reconnexion pour vérifier ce guide...',
    ...
    'workspace.pageToGuideTitle': 'Envie d’aller plus loin ?',
    'workspace.pageToGuideBody':
      'Cette page ne fait qu’effleurer le sujet. Faites-en un guide à part entière.',
    'workspace.pageToGuideAction': 'Créer un guide là-dessus',
    ...
    'practice.addTopicToKnown': 'Ajouter à ce que je sais',
    'practice.addTopicRevisePages':
  ...
  de: {
    ...
    'workspace.pageBeingWritten': 'Diese Seite wird geschrieben...',
    'workspace.pagesReadySoon': 'In etwa 20 Sekunden fertig',
    'studyGuides.reconnecting': 'Verbindung wird geprüft...',
    'studyGuides.thread': 'Thread',
    ...
    'workspace.pageToGuideTitle': 'Willst du tiefer hinein?',
    'workspace.pageToGuideBody':
      'Diese Seite kratzt nur an der Oberfläche. Mach einen eigenen Leitfaden daraus.',
    'workspace.pageToGuideAction': 'Leitfaden dazu erstellen',
    ...
    'practice.addTopicToKnown': 'Zu meinem Wissen hinzufügen',
    'practice.addTopicRevisePages':
